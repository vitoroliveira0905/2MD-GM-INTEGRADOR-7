                ...
                <div className="d-flex flex-wrap align-items-center justify-content-between">
                    ...
                    <nav className="d-none d-lg-flex gap-4 me-auto ms-5">
                        {dadosUsuario && dadosUsuario.usuario && dadosUsuario.usuario.tipo === "admin" ? (
                            <>
                                <Link href="/administracao/dashboard" className="text-white text-decoration-none d-flex align-items-center gap-2 hover-link">
                                    <i className="bi bi-speedometer2"></i>
                                    <span>Painel</span>
                                </Link>
                                <Link href="/administracao/painelSolicitacao" className="text-white text-decoration-none d-flex align-items-center gap-2 hover-link">
                                    <i className="bi bi-list-check"></i>
                                    <span>Solicitações</span>
                                </Link>
                                <Link href="/administracao/estoque" className="text-white text-decoration-none d-flex align-items-center gap-2 hover-link">
                                    <i className="bi bi-box-seam"></i>
                                    <span>Estoque</span>
                                </Link>
                                <Link href="/administracao/relatorio" className="text-white text-decoration-none d-flex align-items-center gap-2 hover-link">
                            ...
                            >
                                {dadosUsuario && dadosUsuario.usuario && dadosUsuario.usuario.tipo === "admin" ? (
                                    <>
                                        ...
                                        <li>
                                            <Link href="/administracao/painelSolicitacao" className="dropdown-item text-white menu-item-hover">
                                                <i className="bi bi-list-check me-2"></i>
                                                Solicitações
                                            </Link>
                                        </li>
                                        <li>
                                            <Link href="/administracao/estoque" className="dropdown-item text-white menu-item-hover">
                                                <i className="bi bi-box-seam me-2"></i>
                                                Estoque
                                            </Link>
                                        </li>
                                        <li>
                                            <Link href="/administracao/relatorio" className="dropdown-item text-white menu-item-hover">
