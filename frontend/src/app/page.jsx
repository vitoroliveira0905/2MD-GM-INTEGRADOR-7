...
export default function DashboardCliente() {
  ...
  useEffect(() => {
    ...
    if (!estaLogado) router.push("/login");
  }, []);
      ...
      fetch("http://localhost:3001/api/solicitacoes", {
        ...
        .then(data => {
          ...
          setDadosSolicitacoes({
            solicitacoes: data.solicitacoes || data || []
          });
        })
  ...
  if (!dadosUsuario || !dadosSolicitacoes) {
              ...
              <table className="table align-middle">
                ...
                <tbody>
                  {dadosSolicitacoes.solicitacoes
                    ...
                    .sort((a, b) =>
                      ["aprovado", "pendente"].indexOf(a.status) -
                      ["aprovado", "pendente"].indexOf(b.status)
                    )
                    .map((s, i) => (
                      <tr key={i}>
                        <td>
